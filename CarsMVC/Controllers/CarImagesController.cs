...
namespace CarsMVC.Controllers
{
    public class CarImagesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.CarImages.Include(c => c.Car);
        ...
        {
            ViewData["CarId"] = new SelectList(_context.Cars, "Id", "Colour");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CarId,URL,ImageView")] CarImage carImage)
        {
            ...
            ViewData["CarId"] = new SelectList(_context.Cars, "Id", "Colour", carImage.CarId);
            return View(carImage);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CarId,URL,ImageView")] CarImage carImage)
        {
            if (id != carImage.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.CarImages'  is null.");
            }
            var carImage = await _context.CarImages.FindAsync(id);
            if (carImage != null)
            {
